(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper-video__slider")) new swiper_core_Swiper(".swiper-video__slider", {
            ...
            if (document.querySelector(".route__slider")) new swiper_core_Swiper(".route__slider", {
                modules: [ Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.3,
...
***************************************************************************** */
        ...
        function windowLoaded() {
            ...
            function updateHeightSwiperVideoSlider() {
                ...
                const swiperVideoHeightHalf = swiperVideoHeight * .5;
                console.log(swiperVideoHeightHalf);
                document.documentElement.style.setProperty("--swiper-height", `${-swiperVideoHeightHalf}px`);
            }
